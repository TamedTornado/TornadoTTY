...
| `8be5dcd5`: GhosttyKit update to official base `9f0e1719` | **ALREADY AHEAD** | Linux pins `TamedTornado/ghostty` revision `eb1eb628`, based on the reviewed current GTK embed patch stack and its independently reviewable host-menu hook. Do not regress to the macOS lock. |
