...
15 files and two ranges, so a changed, added, removed, or unaccounted hunk is
...
- audit validator: PASS, 15 files / 46 hunks / 9 allowlisted exports / 2
...
- built ABI observation: exactly 9 `T`/`W` exports, each
