...
.applications[0].name == "com.tamedtornado.tornadotty" and
.applications[0].role == "application" and
.applications[0].process_id == $pid and
(nodes | any(.name == "Tornado TTY" and .role == "frame" and
             (.states | index("active")) != null)) and
(nodes | any((.name | startswith("Worklane 1, ")) and .role == "push button" and
             (.states | index("selected")) != null)) and
(nodes | any((.name | startswith("shell, ")) and .role == "push button" and
             (.states | index("selected")) != null)) and
